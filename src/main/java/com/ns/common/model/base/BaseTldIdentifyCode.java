...
public abstract class BaseTldIdentifyCode<M extends BaseTldIdentifyCode<M>> extends Model<M> implements IBean {
	...
	public M setIdentifyCode(java.lang.String identifyCode) {
		set("IDENTIFY_CODE", identifyCode);
		return (M)this;
	}
	
	public java.lang.String getIdentifyCode() {
		return getStr("IDENTIFY_CODE");
	}
