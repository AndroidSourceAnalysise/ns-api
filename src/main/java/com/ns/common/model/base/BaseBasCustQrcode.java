...
public abstract class BaseBasCustQrcode<M extends BaseBasCustQrcode<M>> extends Model<M> implements IBean {
	...
	public M setBgmId(java.lang.String bgmId) {
		set("BGM_ID", bgmId);
		return (M)this;
	}
	
	public java.lang.String getBgmId() {
		return getStr("BGM_ID");
	}
